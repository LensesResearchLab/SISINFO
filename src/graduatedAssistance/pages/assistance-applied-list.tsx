...
import { StatusInformation } from "graduatedAssistance/types/Assistance"
import { getAssistanceStatus } from "graduatedAssistance/services/assistanceService"
...
export const columns: ColumnDef<StatusInformation>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return (
          <Link
            to={`/asistencias_graduadas/lista_estados_inscripcion/${row.original.id}`} 
