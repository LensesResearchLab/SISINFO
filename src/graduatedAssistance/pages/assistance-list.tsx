...
import { Assistance } from "graduatedAssistance/types/Assistance"
import { getGraduatedAssistance } from "graduatedAssistance/services/assistanceService"
...
export const columns: ColumnDef<Assistance>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return (
          <Link
            to={`/asistencias_graduadas/lista_de_asistencias/${row.original.id}`} 
