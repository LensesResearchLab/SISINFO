...
@Injectable()
export class TeachingAssistanceService {
  constructor(
    @InjectRepository(TeachingAssistance) private teachingAssistanceRepository: Repository<TeachingAssistance>
  ){}
  async create(createTeachingAssistanceDto: CreateTeachingAssistanceDto) {
    const teachingAssistance = this.teachingAssistanceRepository.create(createTeachingAssistanceDto);
